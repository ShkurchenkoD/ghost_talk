    ...
    <aside className="space-y-4 xl:sticky xl:top-6">
      <Card className="rounded-3xl">
        <CardHeader className="pb-3">
          <CardTitle className="text-base">Панель фасилітатора</CardTitle>
        </CardHeader>
        <CardContent className="space-y-5">
          <div className="space-y-2">
            ...
            <div className="text-sm text-text-secondary">
              Поточний етап: <span className="font-semibold text-text-primary">{currentStage}</span>
            </div>
          ...
          <div className="space-y-2">
            <p className="text-sm font-medium text-text-primary">Учасники онлайн</p>
          ...
          <div className="rounded-2xl border border-indigo-100 bg-soft-purple p-4">
            ...
            <p className="text-sm text-indigo-900/90">
              На цьому етапі важливо зібрати якомога більше ідей без обговорення. Наступний крок
              — групування схожих думок.
            </p>
          </div>
        </CardContent>
      </Card>
