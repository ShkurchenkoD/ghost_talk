      ...
      <div className="rounded-3xl border border-border bg-card/95 px-4 py-3 shadow-soft backdrop-blur sm:px-5">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-text-primary">Анонімний режим</p>
              <p className="text-xs text-text-secondary">Ваші відповіді ніхто не бачить</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button variant="secondary" size="icon" className="rounded-2xl" aria-label="Копіювати код">
